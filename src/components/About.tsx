  ...
  return (
    <section id="o-nas" className="py-24 relative tech-pattern">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Polish AI <span className="text-[#42DCA3]">Breakfasts</span></h2>
        
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-[#42DCA3]">Poznaj naszą społeczność</h3>
            <p className="text-gray-300 mb-6">
              Polish AI Breakfasts to przestrzeń dla wszystkich zainteresowanych sztuczną inteligencją - od początkujących entuzjastów po doświadczonych ekspertów. Nasze spotkania to unikalna okazja do zdobycia praktycznej wiedzy, nawiązania kontaktów i wymiany doświadczeń w przyjaznej atmosferze.
            </p>
          ...
          <div className="relative">
            <img 
              ...
              className="rounded-lg shadow-lg border border-[#42DCA3]/30"
            />
            <div className="absolute -bottom-3 -right-3 w-full h-full border-2 border-[#42DCA3] rounded-lg -z-10"></div>
          </div>
        </div>
        
        <div className="mt-20">
          <h3 className="text-2xl font-bold mb-8 text-center">Legendy <span className="text-[#42DCA3]">świata AI</span></h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="tech-card">
              <div className="h-12 w-12 rounded-full bg-[#42DCA3]/20 flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#42DCA3]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
