...
const ForWho = () => {
  return (
    <section id="dla-kogo" className="py-16 bg-[#0a1122]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-[#111a2f] p-6 rounded-lg">
            <div className="flex items-center justify-center mb-4">
              <span className="text-3xl font-bold text-[#56FF8F]">1</span>
            </div>
            <h3 className="text-xl font-bold mb-3 text-center text-[#56FF8F]">Entuzjaści AI</h3>
            <p>
          ...
          <div className="bg-[#111a2f] p-6 rounded-lg">
            <div className="flex items-center justify-center mb-4">
              <span className="text-3xl font-bold text-[#56FF8F]">2</span>
            </div>
            <h3 className="text-xl font-bold mb-3 text-center text-[#56FF8F]">Naukowcy i specjaliści</h3>
            <p>
          ...
          <div className="bg-[#111a2f] p-6 rounded-lg">
            <div className="flex items-center justify-center mb-4">
              <span className="text-3xl font-bold text-[#56FF8F]">3</span>
            </div>
            <h3 className="text-xl font-bold mb-3 text-center text-[#56FF8F]">Startupy</h3>
            <p>
          ...
          <div className="bg-[#111a2f] p-6 rounded-lg">
            <div className="flex items-center justify-center mb-4">
              <span className="text-3xl font-bold text-[#56FF8F]">4</span>
            </div>
            <h3 className="text-xl font-bold mb-3 text-center text-[#56FF8F]">Biznes i inwestorzy</h3>
            <p>
