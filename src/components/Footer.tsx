      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <div className="flex space-x-8">
            <a href="#o-nas" className="text-gray-300 hover:text-[#42DCA3] transition-colors">O nas</a>
            <a href="#agenda" className="text-gray-300 hover:text-[#42DCA3] transition-colors">Agenda</a>
            <a href="#dla-kogo" className="text-gray-300 hover:text-[#42DCA3] transition-colors">Dla kogo</a>
            <a href="#galeria" className="text-gray-300 hover:text-[#42DCA3] transition-colors">Galeria</a>
          </div>
        </div>
