      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          ...
          <p className="max-w-[700px] text-gray-300 md:text-xl">
            Polish AI Breakfasts łączy lokalne społeczności AI z całej Polski, tworząc przestrzeń do wymiany wiedzy, nawiązywania kontaktów i wspólnego rozwoju.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex flex-col space-y-4 bg-[#111a2f] p-6 rounded-lg">
            <h3 className="text-xl font-bold text-[#56FC8D]">Jesteśmy w całej Polsce</h3>
          ...
          <div className="flex flex-col space-y-4 bg-[#111a2f] p-6 rounded-lg">
            <h3 className="text-xl font-bold text-[#56FC8D]">Łączymy różnorodne perspektywy</h3>
            <p className="text-gray-300">
          ...
          <div className="flex flex-col space-y-4 bg-[#111a2f] p-6 rounded-lg">
            <h3 className="text-xl font-bold text-[#56FC8D]">Budujemy ekosystem AI</h3>
            <p className="text-gray-300">
          ...
          <div className="flex flex-col space-y-4 bg-[#111a2f] p-6 rounded-lg">
            <h3 className="text-xl font-bold text-[#56FC8D]">Wspieramy networking</h3>
            <p className="text-gray-300">
        ...
        <div className="flex justify-center mt-10">
          <a 
            ...
            className="inline-flex items-center rounded-md bg-[#56FC8D] px-6 py-3 text-lg font-medium text-black hover:bg-[#3fe474] transition-colors"
          >
